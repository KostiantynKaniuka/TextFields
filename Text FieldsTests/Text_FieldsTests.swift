...
class Text_FieldsTests: XCTestCase {
    ...
    func testNodidgitsField_IgnoreDidgits() throws {
        //Given
        let inputWithNoDidgits = "abcd"
        let inputContainDidgits = "123asd"
        //Then
        XCTAssertTrue(sut.isValidNoDigitsString(userInput:inputWithNoDidgits))
        XCTAssertFalse(sut.isValidNoDigitsString(userInput: inputContainDidgits))
    ...
    func testValidationRulesTextField_IsContainsDigit() throws {
        ...
        //Then
        XCTAssertTrue(sut.isContainingDigits(text: inputContainingDigit))
        XCTAssertFalse(sut.isContainingDigits(text: inputWithoutDigits))
    }
